...
<body>
    <div class="container">
        ...
        <div class="header">
            <h2>Admin List</h2>
            <div class="actions">
                <a href="index.php?action=add" class="btn">Add New Admin</a>
        ...
        <tr>
            ...
            <td class="actions">
                <a href="index.php?action=edit&id=<?= $admin['admin_id'] ?>">Edit</a>
                <a href="index.php?action=delete&id=<?= $admin['admin_id'] ?>" class="delete-link" onclick="return confirm('Are you sure?')">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </table>
