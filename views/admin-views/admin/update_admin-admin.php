...
<body>
    <div class="container">
        ...
        <form method="post">
            ...
            <input type="text" id="security_answer" name="security_answer" value="<?= htmlspecialchars($admin['security_answer']) ?>" required>

            <button type="submit">Update</button>
        </form>

        <a href="index.php?action=index" class="back-link">Back to Admin List</a>
    </div>
</body>
</html>
