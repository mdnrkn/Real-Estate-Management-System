...
<body>
    <div class="container">
        ...
        <div class="header">
            <h2>Staff List</h2>
            <div class="actions">
                <a href="index.php?action=staff_add" class="btn">Add New Staff</a>
        ...
        <tr>
            ...
            <td class="actions">
                <a href="index.php?action=staff_edit&id=<?= $member['staff_id'] ?>">Edit</a>
                <a href="index.php?action=staff_delete&id=<?= $member['staff_id'] ?>" class="delete-link" onclick="return confirm('Are you sure?')">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
        </table>
