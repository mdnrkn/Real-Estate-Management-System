...
<body>
    <div class="container">
        ...
        <form method="post">
            <label for="property_owner_id">Property Owner ID:</label>
            <input type="text" id="property_owner_id" name="property_owner_id" value="<?= htmlspecialchars($form_data['property_owner_id']) ?>" required>
